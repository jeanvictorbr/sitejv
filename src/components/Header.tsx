...
import { useUserData } from '../hooks/useUserData'; // Importado
...
export function Header() {
  ...
  // --- RENDERIZAÇÃO CONDICIONAL DO BOTÃO/MENU DO USUÁRIO ---
  const authControls = user ? (
    <Menu shadow="md" width={200}>
      ...
      <Menu.Dropdown>
        ...
        {/* ▼▼▼ LINK DE FEEDBACK ADICIONADO AQUI ▼▼▼ */}
