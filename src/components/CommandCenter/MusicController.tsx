...
import { useMusicPlayer } from '../../hooks/useMusicPlayer'; // Supondo que a lógica esteja em um hook
...
export function MusicController() {
  // ATENÇÃO: A lógica abaixo precisa ser conectada ao seu MusicPlayer.tsx real
  // Estou usando o hook 'useMusicPlayer' como exemplo
    ...
    <Popover width={280} position="bottom" withArrow shadow="md">
      ...
      <Popover.Dropdown>
        <Box p="xs">
          ...
          <Text ta="center" size="xs" c="dimmed" truncate="end">{currentSong?.artist}</Text>
